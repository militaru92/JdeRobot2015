...
const ::std::string __Message__Monitor__publish_name = "publish";
...
void
IceProxy::Message::Monitor::publish(const ::Message::Num& m, const ::Ice::Context* __ctx)
{
    ::IceInternal::InvocationObserver __observer(this, __Message__Monitor__publish_name, __ctx);
    int __cnt = 0;
    while(true)
    {
        ...
        try
        {
            ...
            __del->publish(m, __ctx, __observer);
            return;
        }
...
::Ice::AsyncResultPtr
IceProxy::Message::Monitor::begin_publish(const ::Message::Num& m, const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
    ::IceInternal::OutgoingAsyncPtr __result = new ::IceInternal::OutgoingAsync(this, __Message__Monitor__publish_name, __del, __cookie);
    try
    {
        __result->__prepare(__Message__Monitor__publish_name, ::Ice::Normal, __ctx);
...
void
IceProxy::Message::Monitor::end_publish(const ::Ice::AsyncResultPtr& __result)
{
    __end(__result, __Message__Monitor__publish_name);
}
...
void
IceDelegateM::Message::Monitor::publish(const ::Message::Num& m, const ::Ice::Context* __context, ::IceInternal::InvocationObserver& __observer)
{
    ::IceInternal::Outgoing __og(__handler.get(), __Message__Monitor__publish_name, ::Ice::Normal, __context, __observer);
    try
    {
...
void
IceDelegateD::Message::Monitor::publish(const ::Message::Num& m, const ::Ice::Context* __context, ::IceInternal::InvocationObserver&)
{
    ...
    __initCurrent(__current, __Message__Monitor__publish_name, ::Ice::Normal, __context);
    try
    {
...
::Ice::DispatchStatus
Message::Monitor::___publish(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
